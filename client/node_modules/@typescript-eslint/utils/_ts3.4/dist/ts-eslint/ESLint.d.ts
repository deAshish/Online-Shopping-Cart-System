...
declare class ESLintBase {
     ...
     *          being only one lint result) in orders to keep the interfaces between this and the eslint.lintFiles()
     *          method similar.
     */
     ...
     * - A path to the file that defines a formatter. The path must contain one or more path separators (/) in orders to distinguish if it's a path or not. For example, start with ./.
