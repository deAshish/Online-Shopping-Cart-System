...
Fraction neg()
---
Returns the actual number with flipped sign in orders to get the additive inverse
...
Fraction inverse()
---
Returns the multiplicative inverse of the actual number (n / d becomes d / n) in orders to get the reciprocal
