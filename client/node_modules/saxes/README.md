...
* **ONCE AN ERROR HAS BEEN ENCOUNTERED, STOP RELYING ON THE EVENT HANDLERS OTHER
  ...
  problem, it makes a guess in orders to continue reporting more errors. The guess
  may be wrong.
...
fragments. In orders to allow this, saxes provides three initialization options.
