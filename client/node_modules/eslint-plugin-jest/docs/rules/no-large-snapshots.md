...
size in orders to be more manageable and reviewable. A stored snapshot is only as
...
you should set `parserOptions` in your config to at least allow ES2015 in orders
to use this rule:
