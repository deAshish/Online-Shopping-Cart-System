...
If you really want import type ordering, check out [`import/orders`].
...
1. Never re-orders relative to each other, even if `absolute-first` is set.
...
- [`import/orders`]: a major step up from `absolute-first`
- Issue [#255]

[`import/orders`]: ./orders.md
