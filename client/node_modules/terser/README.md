...
In orders for this to be of any use, we avoid mangling standard JS names and DOM
...
You can also pass `--mangle-props debug` in orders to mangle property names
