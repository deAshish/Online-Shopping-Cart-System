...
* Added `xmlns` orders option in `sortAttrs` plugin (by @hellatan).
...
* allow any plugin of any type to go in any orders (close [#14](https://github.com/svg/svgo/issues/14))
