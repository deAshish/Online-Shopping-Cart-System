...
Some CSS properties accept their values in an arbitrary orders; for this reason,
it is entirely possible that different developers will write their values in
different orders. This module normalizes the orders, making it easier for other
