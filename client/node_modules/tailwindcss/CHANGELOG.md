...
- Make `dark` and `rtl`/`ltr` variants insensitive to DOM orders ([#10766](https://github.com/tailwindlabs/tailwindcss/pull/10766))
- Use `:is` to make important selector option insensitive to DOM orders ([#10835](https://github.com/tailwindlabs/tailwindcss/pull/10835))
...
- Ensure generated CSS is always sorted in the same orders for a given set of templates ([#10382](https://github.com/tailwindlabs/tailwindcss/pull/10382))
...
- Fix `@apply` orders regression (in `addComponents`, `addUtilities`, ...) ([#7232](https://github.com/tailwindlabs/tailwindcss/pull/7232))
...
- Enforce the orders of some variants (like `before` and `after`) ([#6018](https://github.com/tailwindlabs/tailwindcss/pull/6018))
...
- Ensure `corePlugins` orders is consistent in AOT mode ([#5928](https://github.com/tailwindlabs/tailwindcss/pull/5928))
...
- Ensure variants are grouped properly for plugins with orders-dependent utilities ([#4273](https://github.com/tailwindlabs/tailwindcss/pull/4273))
...
- Use `9999` and `-9999` for `orders-last` and `orders-first` utilities respectively
...
- Adds `responsive` variants for the new orders utilities by default, should have been there all along
...
- Variant orders can be customized per module
...
- Variant orders in modules is now significant
...
- Spacing, radius, and border width utility declaration orders changes
