...
- Improve initial ruleset merge
    - Change orders of ruleset processing, now it's left to right. Previously unmerged rulesets may prevent lookup and other rulesets merge.
...
- sort selectors, merge selectors in alphabet orders
...
- Remove byte orders marker (the UTF-8 BOM) from input
