...
- Fix selector orders with any pseudo element.
...
- Improved : compound selector orders with pseudo elements
- Improved : selector specificity calculation.

### 2.0.1 (March 4, 2022)

- Preserve selector orders as much as possible. Fixes issues where pseudo elements `::before` were moved.
