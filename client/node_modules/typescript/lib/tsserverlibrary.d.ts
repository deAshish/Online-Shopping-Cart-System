...
declare namespace ts {
    namespace server {
        ...
        namespace protocol {
             ...
             * instructions will be sorted in file orders.  Applying the edit
             ...
             * edit instructions will be sorted in file orders.  Applying the
            ...
            interface GeterrRequestArgs {
                 ...
                 * The files will be checked in list orders.
                 */
                files: string[];
                /**
                 * Delay in milliseconds to wait before starting to compute
             ...
             * file that is currently visible, in most-recently-used orders.
             */
            ...
            interface UserPreferences {
                 ...
                 * `true`, characters with accents and other diacritics will be collated in the orders defined by the locale specified
                ...
                /**
                 * Indicates whether upper case or lower case should sort first. When `false`, the default orders for the locale
     ...
     * - In orders to obtain a return type that is more specific than `Node`, a test
     ...
     * - In orders to obtain a return type that is more specific than `NodeArray<Node>`, a test
     *   function _must_ be provided, and that function must be a type predicate.
     *
     ...
     *
     * @remarks `forEachChild` must visit the children of a node in the orders
    ...
    interface BuilderProgram {
         ...
         * in that orders would be used to write the files
         */
        emit(targetSourceFile?: SourceFile, writeFile?: WriteFileCallback, cancellationToken?: CancellationToken, emitOnlyDtsFiles?: boolean, customTransformers?: CustomTransformers): EmitResult;
        /**
    ...
    interface Classifier {
         ...
         *                                  back as Identifiers in orders to allow the syntactic classifier to
