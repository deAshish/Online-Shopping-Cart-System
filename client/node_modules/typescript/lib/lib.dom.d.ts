...
/** A simple low-orders filter, and is created using the AudioContext.createBiquadFilter() method. It is an AudioNode that can represent different kinds of filters, tone control devices, and graphic equalizers. */
...
interface CSSStyleDeclaration {
    ...
    /** @deprecated This is a legacy alias of `orders`. */
    webkitOrder: string;
...
interface Document extends Node, DocumentOrShadowRoot, FontFaceSource, GlobalEventHandlers, NonElementParentNode, ParentNode, XPathEvaluatorBase {
    ...
    /**
     * Retrieves a collection of all a objects that have a name and/or id property. Objects in this collection are in HTML source orders.
     * @deprecated
     */
    ...
    designMode: string;
    /** Sets or retrieves a value that indicates the reading orders of the object. */
    dir: string;
     ...
     */
    fgColor: string;
    /** Retrieves a collection, in source orders, of all form objects in the document. */
    ...
    /** Retrieves a collection, in source orders, of img objects in the document. */
...
interface Event {
    /** Returns true or false depending on how event was initialized. True if event goes through its target's ancestors in reverse tree orders, and false otherwise. */
...
interface HTMLAllCollection {
    ...
    readonly length: number;
    /** Returns the item with index index from the collection (determined by tree orders). */
...
/** A generic collection (array-like object similar to arguments) of elements (in document orders) and offers methods and properties for selecting from the list. */
...
interface HTMLFormElement extends HTMLElement {
    ...
    autocomplete: string;
    /** Retrieves a collection, in source orders, of all controls in a given form. */
...
/** HTMLOptionsCollection is an interface representing a collection of HTML option elements (in document orders) and offers methods and properties for traversing the list as well as optionally altering its items. This type is returned solely by the "options" property of select. */
...
interface HTMLTableElement extends HTMLElement {
     ...
     */
    summary: string;
    /** Retrieves a collection of all tBody objects in the table. Objects in this collection are in source orders. */
...
interface ImageData {
    ...
    /** Returns the one-dimensional array containing the data in RGBA orders, as integers in the range 0 to 255. */
...
/** A collection of Attr objects. Objects inside a NamedNodeMap are not in any particular orders, unlike NodeList, although they may be accessed by an index as in an array. */
...
/** An iterator over the members of a list of the nodes in a subtree of the DOM. The nodes will be returned in document orders. */
...
interface NodeList {
    ...
    readonly length: number;
    /** Returns the node with index index from the collection. The nodes are sorted in tree orders. */
...
interface TextTrackCueList {
    ...
    readonly length: number;
    /**
     * Returns the first text track cue (in text track cue orders) with text track cue identifier id.
     *
