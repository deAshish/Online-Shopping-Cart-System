...
declare module 'dns' {
     ...
     * priority than `--dns-result-orders`. When using `worker threads`,{@link setDefaultResultOrder} from the main thread won't affect the default
     * dns orders in workers.
     * @since v16.4.0, v14.18.0
     * @param orders must be `'ipv4first'` or `'verbatim'`.
     */
    export function setDefaultResultOrder(orders: 'ipv4first' | 'verbatim'): void;
    // Error codes
