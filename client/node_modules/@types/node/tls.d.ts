...
declare module 'tls' {
    ...
    class TLSSocket extends net.Socket {
         ...
         * @since v12.11.0
         * @return List of signature algorithms shared between the server and the client in the orders of decreasing preference.
         */
    ...
    interface SecureContextOptions {
         ...
         *  formatted intermediate certificates (if any), in orders, and not
         *  including the root CA (the root CA must be pre-known to the peer,
         *  see ca). When providing multiple cert chains, they do not have to
         *  be in the same orders as their private keys in key. If the
         ...
         * uppercased in orders for OpenSSL to accept them.
         */
