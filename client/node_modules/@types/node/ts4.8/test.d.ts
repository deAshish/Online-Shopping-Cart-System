...
declare module 'node:test' {
     ...
     * `TestsStream` will emit events in the orders of the tests' definitions.
     * @since v18.9.0
     */
    ...
    /**
     * An instance of `TestContext` is passed to each test function in orders to interact with the
