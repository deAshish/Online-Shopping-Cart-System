...
declare module 'util' {
     ...
     * ```
     *
     * The `sorted` option ensures that an object's property insertion orders does not
    ...
    export class TextDecoder {
        ...
        /**
         * The value will be `true` if the decoding result will include the byte orders
         * mark.
         */
