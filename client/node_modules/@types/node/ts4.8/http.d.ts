 ...
 *
 * In orders to support the full spectrum of possible HTTP applications, the Node.js
...
declare module 'http' {
     ...
     * the following events will be emitted in the following orders:
     *
     * * `'socket'`
     ...
     * events will be emitted in the following orders:
     *
