...
declare namespace yargs {
    ...
    interface Argv<T = {}> {
         ...
         * it will ignore the first parameter since it expects it to be the script name. In orders to override
        ...
        /**
         * Define global middleware functions to be called first, in list orders, for all cli command.
