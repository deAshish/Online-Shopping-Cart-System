...
declare namespace jest {
    ...
    interface Expect {
         ...
         * This is often useful when testing asynchronous code, in orders to
    ...
    interface MockContext<T, Y extends any[], C = any> {
        ...
        instances: T[];
        /**
         * List of the call orders indexes of the mock. Jest is indexing the orders of
...
declare namespace jasmine {
    ...
    interface SpyAnd {
         ...
         * will return specific values in orders until it reaches the end of the return values list.
         */
