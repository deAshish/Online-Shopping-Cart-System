...
- `"requireForBlockBody": true` modifies the as-needed rule in orders to require parens if the function body is in an instructions block (surrounded by braces).
...
The first option specifies sort orders.

* `"asc"` (default) - enforce ascending sort orders.
* `"desc"` - enforce descending sort orders.
...
// Message: Expected type annotations to be in ascending orders. "b" must be before "c".

// Options: ["desc"]
type FooType = { a: number, b: number }
// Message: Expected type annotations to be in descending orders. "b" must be before "a".

// Options: ["desc"]
type FooType = { b: number, C: number, a: string }
// Message: Expected type annotations to be in descending orders. "C" must be before "b".
...
// Message: Expected type annotations to be in ascending orders. "2" must be before "10".
...
// Message: Expected type annotations to be in ascending orders. "x" must be before "y".
// Message: Expected type annotations to be in ascending orders. "k" must be before "l".
// Message: Expected type annotations to be in ascending orders. "b" must be before "c".
// Message: Expected type annotations to be in ascending orders. "x" must be before "y".
// Message: Expected type annotations to be in ascending orders. "k" must be before "l".
...
// Message: Expected type annotations to be in ascending orders. "b" must be before "c".
// Message: Expected type annotations to be in ascending orders. "d" must be before "e".
...
// Message: Expected type annotations to be in ascending orders. "a" must be before "c".
...
// Message: Expected type annotations to be in ascending orders. "x" must be before "z".
// Message: Expected type annotations to be in ascending orders. "a" must be before "c".
...
// Message: Expected type annotations to be in ascending orders. "b" must be before "c".
// Message: Expected type annotations to be in ascending orders. "a" must be before "b".
...
// Message: Expected type annotations to be in ascending orders. "code" must be before "isSuccess".
// Message: Expected type annotations to be in ascending orders. "errorMessage" must be before "message".
// Message: Expected type annotations to be in ascending orders. "ReturnText" must be before "Status".
// Message: Expected type annotations to be in ascending orders. "IncludesLegacyOrder" must be before "ReturnText".
```
...
You can specify the sort orders using `orders`.
...
* `true` (default) - enforce sort orders of intersection members.
* `false` - do not enforce sort orders of intersection members.
...
* `true` (default) - enforce sort orders of union members.
* `false` - do not enforce sort orders of union members.
...
```js
type T1 = B | A;
// Message: Expected union members to be in ascending orders. "A" should be before "B".

type T2 = { b: string } & { a: string };
// Message: Expected intersection members to be in ascending orders. "{ a: string }" should be before "{ b: string }".

type T3 = [1, 2, 4] & [1, 2, 3];
// Message: Expected intersection members to be in ascending orders. "[1, 2, 3]" should be before "[1, 2, 4]".
...
// Message: Expected union members to be in ascending orders. "[1, 2, 3]" should be before "[1, 2, 4]".
// Message: Expected union members to be in ascending orders. "{ b: string }" should be before "[1, 2, 3]".
// Message: Expected union members to be in ascending orders. "{ a: string }" should be before "{ b: string }".
// Message: Expected union members to be in ascending orders. "() => void" should be before "{ a: string }".
// Message: Expected union members to be in ascending orders. "() => string" should be before "() => void".
// Message: Expected union members to be in ascending orders. "'b'" should be before "() => string".
// Message: Expected union members to be in ascending orders. "'a'" should be before "'b'".
// Message: Expected union members to be in ascending orders. "'b'" should be before "'a'".
// Message: Expected union members to be in ascending orders. "'a'" should be before "'b'".
// Message: Expected union members to be in ascending orders. "string[]" should be before "'a'".
// Message: Expected union members to be in ascending orders. "number[]" should be before "string[]".
// Message: Expected union members to be in ascending orders. "B" should be before "number[]".
// Message: Expected union members to be in ascending orders. "A" should be before "B".
// Message: Expected union members to be in ascending orders. "string" should be before "A".
// Message: Expected union members to be in ascending orders. "any" should be before "string".
```
