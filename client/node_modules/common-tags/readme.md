...
- In orders to use `common-tags`, your environment will also need to support ES2015 tagged templates ([pssst… check Babel out](http://babeljs.io))
...
You can wrap a transformer in a function that receives arguments in orders to create a dynamic plugin:
...
You can pass a list of transformers, and `TemplateTag` will call them on your tag in the orders they are specified:
