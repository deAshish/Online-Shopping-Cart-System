 ...
 * Add estree test for correct orders of directives (Daniel Tschinder)
...
Ensure that you enable the `classProperties` plugin in orders to enable correct parsing of class properties. Prior to this version it was possible to parse them by enabling the `flow` plugin but this was not intended the behaviour.
