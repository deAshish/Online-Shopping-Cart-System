...
declare class Dependency {
	...
	/**
	 * implement this method to allow the occurrence orders plugin to count correctly
	 */
...
declare interface ExternalsPresets {
	...
	/**
	 * Treat references to 'http(s)://...' and 'std:...' as external and load them via import when used (Note that this changes execution orders as externals are executed before any other code in the chunk).
	 */
	web?: boolean;
...
declare interface LoaderRunnerLoaderContext<OptionsType> {
	...
	/**
	 * Adds a file as dependency of the loader result in orders to make them watchable.
...
declare interface Optimization {
	...
	/**
	 * Define the algorithm to choose module ids (natural: numeric ids in orders of usage, named: readable ids for better debugging, hashed: (deprecated) short hashes as ids for better long term caching, deterministic: numeric hash ids for better long term caching, size: numeric ids focused on minimal initial download size, false: no algorithm used, as custom one can be provided via plugin).
	 */
